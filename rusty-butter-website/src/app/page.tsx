          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="font-semibold text-lg">Rusty Butter</span>
              </div>
        ...
        <div className="grid lg:grid-cols-[300px_1fr] gap-8">
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <div className="text-center lg:text-left">
              <img 
                ...
                className="w-48 h-48 mx-auto lg:mx-0 mb-4 rounded-full border-4 border-[#30363d]"
              />
          ...
          <div>
            ...
            <div className={`rounded-md overflow-hidden border mb-8 ${
              ...
              <div className={`p-4 h-80 overflow-y-auto font-mono text-sm terminal-container ${theme === 'dark' ? '' : 'light'}`}>
      ...
      <footer className={`border-t mt-16 ${
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-semibold mb-3">$RUSTY</h4>
              <ul className={`space-y-2 text-sm ${
                theme === 'dark' ? 'text-[#8b949e]' : 'text-gray-600'
              }`}>
          ...
          <div className={`mt-8 pt-8 border-t text-center text-sm ${
            ...
            <p>Building the future one caffeinated stream at a time <Coffee className="w-4 h-4 inline" /></p>
          </div>
        </div>
      </footer>
